...
const ViewClue = ({ setShowClueView, isHeaderClass = false }) => {
  ...
  return (
    <div className="block md:hidden">
      <div className={`${isHeaderClass ? "clue-page-wrap" : "page-wrap-bg-dk clue-page-wrap"}`}>
        <div className="relative main-wrapper mx-auto">
          <div className="buton-wrap-top">
            <button type="button" onClick={() => toggleClueView()} className="bg-gray-1 rounded-lg px-2 py-2 hover:bg-white focus:outline-none focus:ring-2 focus:ring-inset">
      ...
      <div className="bg-white h-full overflow-x-hidden">
        <div className="clue-content clue-view">
          <div className="clue-header flex justify-between relative">
            ...
            <div className="pt-2 hidden md:block">
              <button className="flex rounded-lg bg-gray-2" onClick={() => null}>
                <span>
                  <svg height="11" width="14" fill="none" viewBox="0 0 14 11" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-blue-4 font-semibold text-sm">View Record</span>
              </button>
            </div>
          </div>
          ...
          <div className="clue-table flex mt-5 mb-4">
            <div className="table-content bg-white text-left w-full">
              <table className="table-auto w-full">
                ...
                <tbody>
                  <tr className="bg-gray-2" key={11}>
                    <td className="name-col  p-1 break-all hidden md:block">
                      <span className="defaultText secondary-color text-sm typo-font-regular">Name</span>
                    </td>
                    <td className="name-col p-1 break-all">
                      <p className="select-none text-gray-6 defaultText secondary-color text-xs typo-font-regular pr-2 w-32 md:hidden">
                        Name <span className="bg-maroon-5 text-white rounded-sm clue-tag">DIFFERENT</span>
                      </p>
                      <span className="defaultText secondary-color text-sm typo-font-regular">Isaac L Hammack</span>
                    </td>
                    <td className="name-col p-1 break-all">
                      <p className="select-none text-gray-6 defaultText secondary-color text-xs typo-font-regular pr-2 w-32 md:hidden">Name</p>
                      <span className="defaultText secondary-color text-sm typo-font-regular">Isaac Leroy Hammack</span>
                    </td>
                  </tr>
                  <tr key={22}>
                    <td className="name-col  p-1 break-all hidden md:block">
                      <span className="defaultText secondary-color text-sm typo-font-regular">Birth</span>
                    </td>
                    <td className="name-col p-1 break-all">
                      <p className="select-none text-gray-6 defaultText secondary-color text-xs typo-font-regular pr-2 w-32 md:hidden">
                        Birth Date <span className="bg-green-5 text-white rounded-sm clue-tag">NEW</span>
                      </p>
                      <span className="defaultText secondary-color text-sm typo-font-regular">4 May 1890</span>
                    </td>
                    <td className="flex name-col p-1 break-all">
                      <p className="select-none text-gray-6 defaultText secondary-color text-xs typo-font-regular pr-2 w-32 md:hidden">Birth Date</p>
                    </td>
                  </tr>
                  <tr className="bg-gray-2" key={33}>
                    <td className="name-col  p-1 break-all hidden md:block">
                      <span className="defaultText secondary-color text-sm typo-font-regular">Residence</span>
                    </td>
                    <td className="name-col p-1 break-all">
                      <p className="select-none text-gray-6 defaultText secondary-color text-xs typo-font-regular pr-2 w-32 md:hidden">Residence</p>
                  ...
                  <tr key={44}>
                    ...
                    <td className="name-col p-1 break-all">
                      <p className="select-none text-gray-6 defaultText secondary-color text-xs typo-font-regular pr-2 w-32 md:hidden">Marriage Date</p>
                      <span className="defaultText secondary-color text-sm typo-font-regular">30 May 1920</span>
                    </td>
                    <td className="name-col p-1 break-all">
                      <p className="select-none text-gray-6 defaultText secondary-color text-xs typo-font-regular pr-2 w-32 md:hidden">Marriage Date</p>
                      <span className="defaultText secondary-color text-sm typo-font-regular">30 May 1920</span>
                  ...
                  <tr className="bg-gray-2" key={66}>
                    <td className="name-col p-1 break-all">
                      <p className="select-none text-gray-6 defaultText secondary-color text-xs typo-font-regular pr-2 w-32 md:hidden">Race</p>
                      <span className="defaultText secondary-color text-sm typo-font-regular">White</span>
                    </td>
                    <td className="name-col p-1 break-all">
                      <p className="select-none text-gray-6 defaultText secondary-color text-xs typo-font-regular pr-2 w-32 md:hidden">Race</p>
                      <span className="defaultText secondary-color text-sm typo-font-regular">White</span>
                  ...
                  <tr key={77}>
                    <td className="hidden"></td>
                    <td className="name-col p-1 break-all">
                      <p className="select-none text-gray-6 defaultText secondary-color text-xs typo-font-regular pr-2 w-32 md:hidden">Occupation</p>
                      <span className="defaultText secondary-color text-sm typo-font-regular">Keeping House</span>
                    </td>
                    <td className="name-col p-1 break-all">
                      <p className="select-none text-gray-6 defaultText secondary-color text-xs typo-font-regular pr-2 w-32 md:hidden">Occupation</p>
                      <span className="defaultText secondary-color text-sm typo-font-regular">Keeping House</span>
                  ...
                  <tr className="bg-gray-2" key={88}>
                    <td className="hidden"></td>
                    <td className="name-col p-1 break-all">
                      <p className="select-none text-gray-6 defaultText secondary-color text-xs typo-font-regular pr-2 w-32 md:hidden">Spouse</p>
                      <span className="defaultText secondary-color text-sm typo-font-regular">Irving</span>
                    </td>
                    <td className="name-col p-1 break-all">
                      <p className="select-none text-gray-6 defaultText secondary-color text-xs typo-font-regular pr-2 w-32 md:hidden">Spouse</p>
                      <span className="defaultText secondary-color text-sm typo-font-regular">Irving</span>
          ...
          <div className="clue-footer block md:flex md:justify-between p-3">
            <div className="flex">
              <div>
            ...
            <div className="flex justify-between pt-4">
              <div>
                <button className="flex bg-gray-2 rounded-lg view-btn">
                  <span>
              ...
              <div className="block md:flex text-right">
                <button className="bg-blue-4 text-sm text-white mr-2 rounded-lg option-btn" onClick={() => handleShowModel()}>
                  Yes
                </button>
                <button className="bg-gray-2 text-sm text-blue-4 rounded-lg option-btn">No</button>
              </div>
            </div>
          </div>
        </div>
