...
const Dpa = () => {
  ...
  const isAccessedDPA = getAccessCode();
  const isAccessTokenDPA= getAccessToken()
  const { instance } = useMsal();

  const DPAHeader = () => {
    return (
      <div style={{ zIndex: 100 }} className="shadow-md header bg-white z-500">
  ...
  return (
   <>
    {isAccessedDPA && !isAccessTokenDPA && (
        <DPAHeader />
      )}
    <div className="bg-gray-2 privacy">
      <div className="pt-18 md:pt-22.5 all-stories-page-wrap main-wrapper mx-auto w-full">
        <div className="bg-white rounded-lg p-7 mb-9">
          <h1 className="font-bold text-xl text-black">Data Security Measures</h1>
          <p className="text-sm text-black mb-4 mt-4">This document describes the technical and organizational measures we have adopted and will adopt to ensure that the data we process is safe in our care.</p>

          <h2 className="font-bold text-base text-black">1. Subprocessing</h2>
          <div>
            <ol className="footer-decimal-alpha">
              <li className="text-sm text-black ml-12">
                ...
                <ol>
                  <li className="text-sm text-black ml-10">Large-scale subprocessors and service providers such as cloud providers (AWS, Google Cloud or Azure) have their own data processing agreements (“DPA”) under which they agree to comply with applicable laws and standards. We will confirm that those DPA’s are in place.</li>
                  <li className="text-sm text-black ml-10">
                    Smaller or newer subprocessors and service providers that do not necessarily have their own DPA’s will be required to sign our DPA. Our DPA will be continually updated and posted on our website at <a href={`${hostUrl}/dpa`}>{`${hostUrl}/dpa`}</a>.
                  </li>
                </ol>
              </li>
              <li className="text-sm text-black ml-12">In each case, and via the DPA’s, World Archives will restrict the subprocessors’ access to customer personal data only to what is necessary to assist World Archives in providing or maintaining the services and will prohibit the subprocessor from accessing customer personal data for any other purpose.</li>
              <li className="text-sm text-black ml-12">
                ...
                <ol>
                  <li className="text-sm text-black ml-10">They must enter into a DPA with us that contains provisions similar to our DPA.</li>
                  <li className="text-sm text-black ml-10">They must disclose any threatened or active legal actions against them regarding data or privacy issues or breaches.</li>
          ...
          <h2 className="font-bold text-base text-black mt-4">2. Security Measures</h2>
          <p className="text-sm text-black">World Archives has implemented and will maintain appropriate technical and organizational security measures to protect customer personal data from security incidents and to preserve the security and confidentiality of the customer personal data ("Security Measures"). The Security Measures applicable to the Services are as follows:</p>
          <div>
            <ol className="footer-list2">
              <li className="text-sm text-black ml-12">Web Application Penetration Test: World Archives shall continue to annually engage an independent, third-party to perform a web application penetration test. We will address all medium, critical and severe vulnerabilities in the findings of the report within a reasonable, risk-based timeframe.</li>
              <li className="text-sm text-black ml-12">
                ...
                <ul>
                  <li className="text-sm text-black ml-10">The importance of information security and proper handling of PII.</li>
                  <li className="text-sm text-black ml-10">Physical controls such as visitor protocols, safeguarding portable devices and proper data destruction.</li>
                  <li className="text-sm text-black ml-10">Logical controls related to strong password selection/best practices.</li>
                  <li className="text-sm text-black ml-10">How to recognize social engineering attacks such as phishing.</li>
                </ul>
              </li>
              <li className="text-sm text-black ml-12">
                Employee-Related Policies:
                <ol>
                  <li className="text-sm text-black ml-10">Unauthorized persons will be prevented from gaining physical access to our premises and the rooms where data processing systems are located.</li>
                  <li className="text-sm text-black ml-10">We will ensure that all computers processing personal data (including computers with remote access) are password protected, both after booting up and when left inactive.</li>
                  <li className="text-sm text-black ml-10">We will only grant system access to our authorized personnel and strictly limit their access to applications required for those personnel to fulfil their specific responsibilities.</li>
                  <li className="text-sm text-black ml-10">We will implement a password policy that prohibits the sharing of passwords.</li>
                  <li className="text-sm text-black ml-10">We will have adopted procedures to deactivate user accounts when an employee, agent, or administrator leaves our employ or moves to another responsibility within the company.</li>
                </ol>
              </li>
              <li className="text-sm text-black ml-12">
                Process-Level Requirements: We will implement the following processes to ensure security and privacy:
                <ol>
                  <li className="text-sm text-black ml-10">World Archives shall implement user termination controls that include access removal / disablement promptly upon termination of staff.</li>
                  <li className="text-sm text-black ml-10">Documented change control process will be used to record and approve all major releases in World Archives’ environment.</li>
                  <li className="text-sm text-black ml-10">World Archives shall have and maintain a patch management process to implement patches in a reasonable, risk-based timeframe.</li>
                  <li className="text-sm text-black ml-10">World Archives shall use firewall(s), Security Groups/VPCs, or similar technology to protect servers storing Customer Personal Data.</li>
                  <li className="text-sm text-black ml-10">Where World Archives handles customer personal data, servers shall be protected from unauthorized access with appropriate physical security mechanisms including, but not limited to, badge access control, secure perimeter, and enforced user provisioning controls (i.e. appropriate authorization of new accounts, timely account terminations and frequent user account reviews). These physical security mechanisms are provided by data center partners such as, but not limited to, AWS, Azure, and Google. All cloud-hosted systems shall be scanned, where applicable and where approved by the cloud service provider.</li>
                  <li className="text-sm text-black ml-10">Whenever an employee or contractor leaves or is terminated, that individual’s access to customer user accounts shall be immediately terminated or disabled.</li>
                </ol>
              </li>
              <li className="text-sm text-black ml-12">
                End User Computing Level Requirements
                <ol>
                  <li className="text-sm text-black ml-10">World Archives shall employ an anti-virus solution with daily signature updates for end-user computing devices which connect to the customer network or handle customer personal data.</li>
                  <li className="text-sm text-black ml-10">World Archives will maintain a policy prohibiting the use of removable media for storing or carrying customer personal data. Removable media include flash drives, CDs, and DVDs.</li>
                </ol>
              </li>
              <li className="text-sm text-black ml-12">
                Compliance Requirements
                <ol>
                  <li className="text-sm text-black ml-10">World Archives will implement building access control to control and track access to its networks and other equipment.</li>
                  <li className="text-sm text-black ml-10">World Archives will determine each year which officers and employees within the company will have access to which categories of data and shall review this list annually at the executive level.</li>
                </ol>
              </li>
              <li className="text-sm text-black ml-12">Personnel. World Archives restricts its personnel from processing Customer Personal Data without authorization by World Archives as set forth in the Security Measures and shall ensure that any person who is authorized by World Archives to process Customer Personal Data is under an appropriate obligation of confidentiality.</li>
              <li className="text-sm text-black ml-12">Security Incident Response. Upon becoming aware of a Security Incident, World Archives will notify Customer without undue delay and, in any case, where feasible, within seventy-two (72) hours after becoming aware. World Archives will provide information relating to the Security Incident as it becomes known or as is reasonably requested by Customer to fulfil its obligations as controller and will also take reasonable steps to contain, investigate, and mitigate any Security Incident.</li>
            </ol>
          </div>

          <h2 className="font-bold text-base text-black mt-4">3. Security Incident Response</h2>
          <p className="text-sm text-black">Upon becoming aware of any incident in which it suspects that unauthorized access has been gained to World Archives’ systems, the executives of the company at the highest levels will be immediately notified.</p>
          <div>
            <ol className="footer-list2">
              <li className="text-sm text-black ml-12">Executives will immediately confer with each other and with legal counsel regarding any security incident to ensure compliance with legal and contractual obligations.</li>
              <li className="text-sm text-black ml-12">We will notify the impacted customer(s) within seventy-two (72) hours, where feasible, after learning of the incident.</li>
              <li className="text-sm text-black ml-12">We will immediately investigate and mitigate any security incident.</li>
              <li className="text-sm text-black ml-12">World Archives will obtain and maintain reasonable insurance to cover itself for cyber liability.</li>
            </ol>
          </div>
        </div>
      </div>
